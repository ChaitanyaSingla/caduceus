...
func caduceus(arguments []string) int {
	...
	caduceusSenderWrapper, err := SenderWrapperFactory{
		...
		SqsConsumerCount:         caduceusConfig.Sender.AwsSqs.SqsConsumerCount,
		SqsMsgProducerBatchCount: caduceusConfig.Sender.AwsSqs.SqsMsgProducerBatchCount,
		SqsMsgConsumerBatchCount: caduceusConfig.Sender.AwsSqs.SqsMsgConsumerBatchCount,
	}.New()
